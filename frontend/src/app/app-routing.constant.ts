...
export const DASHBOARD_HUB_WORKFLOW_HUB = `${DASHBOARD_HUB}/workflow-hub`;
export const DASHBOARD_HUB_WORKFLOW_HUB_DETAIL = `${DASHBOARD_HUB_WORKFLOW_HUB}/detail`;
...
export const DASHBOARD_USER_DATASET_BANK = `${DASHBOARD_USER}/dataset-bank`;
...
export const DASHBOARD_USER_OPERATOR_EDIT = `${DASHBOARD_USER_OPERATOR}/edit`;
