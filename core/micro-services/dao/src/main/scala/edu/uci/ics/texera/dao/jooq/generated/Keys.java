...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<ClusterRecord, UserRecord> CLUSTER_IBFK_1 = Internal.createForeignKey(edu.uci.ics.texera.dao.jooq.generated.Keys.KEY_USER_PRIMARY, Cluster.CLUSTER, "cluster_ibfk_1", Cluster.CLUSTER.OWNER_ID);
        public static final ForeignKey<ClusterActivityRecord, ClusterRecord> CLUSTER_ACTIVITY_IBFK_1 = Internal.createForeignKey(edu.uci.ics.texera.dao.jooq.generated.Keys.KEY_CLUSTER_PRIMARY, ClusterActivity.CLUSTER_ACTIVITY, "cluster_activity_ibfk_1", ClusterActivity.CLUSTER_ACTIVITY.CLUSTER_ID);
