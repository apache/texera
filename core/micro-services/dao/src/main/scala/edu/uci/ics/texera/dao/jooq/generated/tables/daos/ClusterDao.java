...
public class ClusterDao extends DAOImpl<ClusterRecord, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster, Integer> {

    /**
     * Create a new ClusterDao without any configuration
     */
    public ClusterDao() {
        super(Cluster.CLUSTER, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster.class);
    }
    ...
    public ClusterDao(Configuration configuration) {
        super(Cluster.CLUSTER, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster.class, configuration);
    }

    @Override
    public Integer getId(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster object) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster> fetchByCid(Integer... values) {
     ...
     */
    public edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster fetchOneByCid(Integer value) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster> fetchByName(String... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster> fetchByMachineType(String... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster> fetchByNumberOfMachines(Integer... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster> fetchByCreationTime(Timestamp... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster> fetchByStatus(ClusterStatus... values) {
