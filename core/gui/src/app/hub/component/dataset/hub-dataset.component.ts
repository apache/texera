...
@UntilDestroy()
@Component({
  selector: "texera-hub-dataset",
  templateUrl: "./hub-dataset.component.html",
  styleUrls: ["./hub-dataset.component.scss"],
})
export class HubDatasetComponent implements AfterViewInit {
