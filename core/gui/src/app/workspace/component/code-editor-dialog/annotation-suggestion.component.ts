...
@Component({
  ...
  template: `
    <div class="annotation-suggestion" [style.top.px]="top" [style.left.px]="left">
      ...
      <button class="accept-button" (click)="onAccept()">Accept</button>
      <button class="decline-button" (click)="onDecline()">Decline</button>
    </div>
  `,
  styles: [`
