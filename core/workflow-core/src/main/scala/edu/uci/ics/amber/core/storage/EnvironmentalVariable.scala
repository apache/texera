...
object EnvironmentalVariable {
  ...
  // Flow Control
  val ENV_FLOW_CONTROL_MAX_CREDIT_ALLOWED_IN_BYTES_PER_CHANNEL = "FLOW_CONTROL_MAX_CREDIT_ALLOWED_IN_BYTES_PER_CHANNEL"
  val ENV_FLOW_CONTROL_CREDIT_POLL_INTERVAL_IN_MS = "FLOW_CONTROL_CREDIT_POLL_INTERVAL_IN_MS"

  // Network Buffering
  val ENV_NETWORK_BUFFERING_DEFAULT_DATA_TRANSFER_BATCH_SIZE = "NETWORK_BUFFERING_DEFAULT_DATA_TRANSFER_BATCH_SIZE"
  val ENV_NETWORK_BUFFERING_ENABLE_ADAPTIVE_BUFFERING = "NETWORK_BUFFERING_ENABLE_ADAPTIVE_BUFFERING"
  val ENV_NETWORK_BUFFERING_ADAPTIVE_BUFFERING_TIMEOUT_MS = "NETWORK_BUFFERING_ADAPTIVE_BUFFERING_TIMEOUT_MS"

  // Reconfiguration
  val ENV_RECONFIGURATION_ENABLE_TRANSACTIONAL_RECONFIGURATION = "RECONFIGURATION_ENABLE_TRANSACTIONAL_RECONFIGURATION"
  ...
  val ENV_RESULT_CLEANUP_COLLECTION_CHECK_INTERVAL_IN_SECONDS = "RESULT_CLEANUP_COLLECTION_CHECK_INTERVAL_IN_SECONDS"

  // Web Server
  val ENV_WEB_SERVER_WORKFLOW_STATE_CLEANUP_IN_SECONDS = "WEB_SERVER_WORKFLOW_STATE_CLEANUP_IN_SECONDS"
  val ENV_WEB_SERVER_PYTHON_CONSOLE_BUFFER_SIZE = "WEB_SERVER_PYTHON_CONSOLE_BUFFER_SIZE"
  val ENV_WEB_SERVER_WORKFLOW_RESULT_PULLING_IN_SECONDS = "WEB_SERVER_WORKFLOW_RESULT_PULLING_IN_SECONDS"
  val ENV_WEB_SERVER_CLEAN_ALL_EXECUTION_RESULTS_ON_SERVER_START = "WEB_SERVER_CLEAN_ALL_EXECUTION_RESULTS_ON_SERVER_START"
  ...
  val ENV_FAULT_TOLERANCE_LOG_RECORD_MAX_SIZE_IN_BYTE = "FAULT_TOLERANCE_LOG_RECORD_MAX_SIZE_IN_BYTE"
  val ENV_FAULT_TOLERANCE_MAX_SUPPORTED_RESEND_QUEUE_LENGTH = "FAULT_TOLERANCE_MAX_SUPPORTED_RESEND_QUEUE_LENGTH"
  ...
  // Schedule Generator
  val ENV_SCHEDULE_GENERATOR_ENABLE_COST_BASED_SCHEDULE_GENERATOR = "SCHEDULE_GENERATOR_ENABLE_COST_BASED_SCHEDULE_GENERATOR"
  ...
  val ENV_SCHEDULE_GENERATOR_SEARCH_TIMEOUT_MILLISECONDS = "SCHEDULE_GENERATOR_SEARCH_TIMEOUT_MILLISECONDS"
