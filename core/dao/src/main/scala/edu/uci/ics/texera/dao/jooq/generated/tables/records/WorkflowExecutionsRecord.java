...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record12<Integer, Integer, Integer, Short, String, LocalDateTime, LocalDateTime, Boolean, String, String, String, String>, IWorkflowExecutions {
    ...
    @Override
    public Row12<Integer, Integer, Integer, Short, String, LocalDateTime, LocalDateTime, Boolean, String, String, String, String> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord value6(LocalDateTime value) {
        setStartingTime(value);
        return this;
    }

    @Override
    public WorkflowExecutionsRecord value7(LocalDateTime value) {
    ...
    @Override
    public WorkflowExecutionsRecord values(Integer value1, Integer value2, Integer value3, Short value4, String value5, LocalDateTime value6, LocalDateTime value7, Boolean value8, String value9, String value10, String value11, String value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(Integer eid, Integer vid, Integer uid, Short status, String result, LocalDateTime startingTime, LocalDateTime lastUpdateTime, Boolean bookmarked, String name, String environmentVersion, String logLocation, String runtimeStatsUri) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
