...
public class ProjectDao extends DAOImpl<ProjectRecord, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project, Integer> {

    /**
     * Create a new ProjectDao without any configuration
     */
    public ProjectDao() {
        super(Project.PROJECT, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project.class);
    }
    ...
    public ProjectDao(Configuration configuration) {
        super(Project.PROJECT, edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project.class, configuration);
    }
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project> fetchByPid(Integer... values) {
     ...
     */
    public edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project fetchOneByPid(Integer value) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project> fetchByName(String... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project> fetchByDescription(String... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project> fetchByOwnerId(Integer... values) {
     ...
     */
    public List<edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Project> fetchByColor(String... values) {
