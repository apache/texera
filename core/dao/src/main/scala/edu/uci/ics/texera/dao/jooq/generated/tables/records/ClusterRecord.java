...
public class ClusterRecord extends UpdatableRecordImpl<ClusterRecord> implements Record7<Integer, String, Integer, String, Integer, Timestamp, ClusterStatus>, ICluster {
    ...
    @Override
    public Row7<Integer, String, Integer, String, Integer, Timestamp, ClusterStatus> valuesRow() {
    ...
    @Override
    public ClusterRecord value3(Integer value) {
        setOwnerId(value);
        return this;
    }
    ...
    @Override
    public ClusterRecord values(Integer value1, String value2, Integer value3, String value4, Integer value5, Timestamp value6, ClusterStatus value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ClusterRecord(Integer cid, String name, Integer ownerId, String machineType, Integer numberOfMachines, Timestamp creationTime, ClusterStatus status) {
        super(Cluster.CLUSTER);
     ...
     * Create a detached, initialised ClusterRecord
     */
    public ClusterRecord(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.Cluster value) {
        super(Cluster.CLUSTER);
        ...
        if (value != null) {
            ...
            setNumberOfMachines(value.getNumberOfMachines());
