...
public class UserActivityRecord extends TableRecordImpl<UserActivityRecord> implements Record6<Integer, Integer, String, String, String, LocalDateTime>, IUserActivity {
    ...
    @Override
    public UserActivityRecord value6(LocalDateTime value) {
        setActivityTime(value);
        return this;
    }

    @Override
    public UserActivityRecord values(Integer value1, Integer value2, String value3, String value4, String value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserActivityRecord(Integer uid, Integer id, String type, String ip, String activate, LocalDateTime activityTime) {
        super(UserActivity.USER_ACTIVITY);
