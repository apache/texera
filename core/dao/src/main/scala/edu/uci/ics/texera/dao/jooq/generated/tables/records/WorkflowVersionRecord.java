...
public class WorkflowVersionRecord extends UpdatableRecordImpl<WorkflowVersionRecord> implements Record4<Integer, Integer, String, LocalDateTime>, IWorkflowVersion {
    ...
    @Override
    public WorkflowVersionRecord values(Integer value1, Integer value2, String value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowVersionRecord(Integer vid, Integer wid, String content, LocalDateTime creationTime) {
        super(WorkflowVersion.WORKFLOW_VERSION);
