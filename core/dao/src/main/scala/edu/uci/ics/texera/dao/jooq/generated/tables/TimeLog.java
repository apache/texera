...
public class TimeLog extends TableImpl<TimeLogRecord> {
     ...
     */
    public final TableField<TimeLogRecord, Integer> UID = createField(DSL.name("uid"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    private TimeLog(Name alias, Table<TimeLogRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> TimeLog(Table<O> child, ForeignKey<O, TimeLogRecord> key) {
