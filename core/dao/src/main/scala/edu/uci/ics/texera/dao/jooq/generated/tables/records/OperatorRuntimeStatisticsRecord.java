...
public class OperatorRuntimeStatisticsRecord extends UpdatableRecordImpl<OperatorRuntimeStatisticsRecord> implements Record9<Long, LocalDateTime, Long, Long, Short, Long, Long, Long, Integer>, IOperatorRuntimeStatistics {
    ...
    @Override
    public Row9<Long, LocalDateTime, Long, Long, Short, Long, Long, Long, Integer> valuesRow() {
    ...
    @Override
    public OperatorRuntimeStatisticsRecord value2(LocalDateTime value) {
        setTime(value);
        return this;
    }
    ...
    @Override
    public OperatorRuntimeStatisticsRecord values(Long value1, LocalDateTime value2, Long value3, Long value4, Short value5, Long value6, Long value7, Long value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OperatorRuntimeStatisticsRecord(Long operatorExecutionId, LocalDateTime time, Long inputTupleCnt, Long outputTupleCnt, Short status, Long dataProcessingTime, Long controlProcessingTime, Long idleTime, Integer numWorkers) {
        super(OperatorRuntimeStatistics.OPERATOR_RUNTIME_STATISTICS);

        setOperatorExecutionId(operatorExecutionId);
        setTime(time);
        setInputTupleCnt(inputTupleCnt);
        setOutputTupleCnt(outputTupleCnt);
        setStatus(status);
        setDataProcessingTime(dataProcessingTime);
        setControlProcessingTime(controlProcessingTime);
     ...
     * Create a detached, initialised OperatorRuntimeStatisticsRecord
     */
    public OperatorRuntimeStatisticsRecord(edu.uci.ics.texera.dao.jooq.generated.tables.pojos.OperatorRuntimeStatistics value) {
        super(OperatorRuntimeStatistics.OPERATOR_RUNTIME_STATISTICS);

        if (value != null) {
            setOperatorExecutionId(value.getOperatorExecutionId());
            setTime(value.getTime());
            setInputTupleCnt(value.getInputTupleCnt());
            setOutputTupleCnt(value.getOutputTupleCnt());
            setStatus(value.getStatus());
            setDataProcessingTime(value.getDataProcessingTime());
            setControlProcessingTime(value.getControlProcessingTime());
            setIdleTime(value.getIdleTime());
            setNumWorkers(value.getNumWorkers());
        }
    }
}
