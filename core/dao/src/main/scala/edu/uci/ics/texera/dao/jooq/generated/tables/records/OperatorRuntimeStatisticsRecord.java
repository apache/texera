...
public class OperatorRuntimeStatisticsRecord extends UpdatableRecordImpl<OperatorRuntimeStatisticsRecord> implements Record8<ULong, Timestamp, ULong, ULong, Byte, ULong, ULong, ULong>, IOperatorRuntimeStatistics {

    private static final long serialVersionUID = 548717260;
    ...
    @Override
    public Row8<ULong, Timestamp, ULong, ULong, Byte, ULong, ULong, ULong> valuesRow() {
    ...
    @Override
    public OperatorRuntimeStatisticsRecord values(ULong value1, Timestamp value2, ULong value3, ULong value4, Byte value5, ULong value6, ULong value7, ULong value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OperatorRuntimeStatisticsRecord(ULong operatorExecutionId, Timestamp time, ULong inputTupleCnt, ULong outputTupleCnt, Byte status, ULong dataProcessingTime, ULong controlProcessingTime, ULong idleTime) {
        super(OperatorRuntimeStatistics.OPERATOR_RUNTIME_STATISTICS);
