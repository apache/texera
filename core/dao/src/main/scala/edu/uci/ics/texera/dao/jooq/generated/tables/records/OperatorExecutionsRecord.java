...
public class OperatorExecutionsRecord extends UpdatableRecordImpl<OperatorExecutionsRecord> implements Record3<Integer, String, String>, IOperatorExecutions {
    ...
    @Override
    public OperatorExecutionsRecord values(Integer value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public OperatorExecutionsRecord(Integer workflowExecutionId, String operatorId, String consoleMessagesUri) {
        super(OperatorExecutions.OPERATOR_EXECUTIONS);
