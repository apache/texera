...
public class OperatorExecutionsRecord extends UpdatableRecordImpl<OperatorExecutionsRecord> implements Record4<ULong, UInteger, String, UInteger>, IOperatorExecutions {

    private static final long serialVersionUID = 554606177;
    ...
    @Override
    public Row4<ULong, UInteger, String, UInteger> valuesRow() {
    ...
    public Field<UInteger> field4() {
        return OperatorExecutions.OPERATOR_EXECUTIONS.NUM_WORKERS;
    }
    ...
    @Override
    public OperatorExecutionsRecord value4(UInteger value) {
        setNumWorkers(value);
        return this;
    }

    @Override
    public OperatorExecutionsRecord values(ULong value1, UInteger value2, String value3, UInteger value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OperatorExecutionsRecord(ULong operatorExecutionId, UInteger workflowExecutionId, String operatorId, UInteger numWorkers) {
        super(OperatorExecutions.OPERATOR_EXECUTIONS);
