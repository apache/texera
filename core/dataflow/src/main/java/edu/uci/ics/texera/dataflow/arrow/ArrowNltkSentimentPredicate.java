...
public class ArrowNltkSentimentPredicate extends PredicateBase {
    ...
    public ArrowNltkSentimentPredicate(
            ...
            @JsonProperty(value = PropertyNameConstants.ARROW_BATCH_SIZE, required = true,
    ...
    @JsonProperty(PropertyNameConstants.ARROW_BATCH_SIZE)
    public int getChunkSize() {
        return this.chunkSize;
    }

    @Override
    public ArrowNltkSentiment newOperator() {
        return new ArrowNltkSentiment(this);
    }

    public static Map<String, Object> getOperatorMetadata() {
        return ImmutableMap.<String, Object>builder()
                .put(PropertyNameConstants.USER_FRIENDLY_NAME, "Nltk Sentiment Analysis using Apache Arrow")
                .put(PropertyNameConstants.OPERATOR_DESCRIPTION, "Sentiment analysis based on Python's NLTK package," +
                        "with Apache Arrow for passing data between processes")
