...
class TesterRPCHandlerInitializer(val myID:ActorVirtualIdentity, rpcClient:RPCClient, rpcServer:RPCServer) extends RPCHandlerInitializer(rpcClient,rpcServer)
