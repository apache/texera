...
//    logicalPlan.opsToReuseCache = List[String]()
...
//    logicalPlan.opsToReuseCache = List(sourceOperator.operatorID)
//
...
//
//    logicalPlan.opsToReuseCache = List(cachedOperatorID)
