from proto.edu.uci.ics.amber.engine.architecture.worker import QueryStatisticsV2, WorkerStatistics
...
class QueryStatisticsHandler(Handler):
    ...
    def __call__(self, context: Context, command: QueryStatisticsV2, *args, **kwargs):
        ...
        return WorkerStatistics(worker_state=state, input_tuple_count=input_count, output_tuple_count=output_count)
