...
from core.models import TupleOperator
...
def load_operator(code: str) -> type(TupleOperator):
    """
...
def is_concrete_operator(cls: type) -> bool:
    ...
    :return: bool
    """
    return inspect.isclass(cls) and issubclass(cls, TupleOperator) and not inspect.isabstract(cls)
