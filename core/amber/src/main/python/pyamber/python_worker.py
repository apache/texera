...
from pyamber.models.internal_queue import InternalQueue
from pyamber.runnables import DataProcessor, NetworkReceiver, NetworkSender
from pyamber.util.runnable.runnable import Runnable
from pyamber.util.stoppable.stoppable import Stoppable
...
class PythonWorker(Runnable, Stoppable):
    ...
    @overrides
    def run(self) -> None:
        network_receiver_thread = Thread(target=self._network_receiver.run, name="network_receiver")
