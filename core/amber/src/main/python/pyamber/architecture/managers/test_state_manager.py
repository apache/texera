...
from pyamber.architecture.managers.state_manager import InvalidStateException, InvalidTransitionException, StateManager
...
class TestStateManager:
    ...
    def test_it_can_transit_to_defined_state(self, state_manager):
        ...
        for state in [WorkerState.READY, WorkerState.PAUSED, WorkerState.RUNNING, WorkerState.COMPLETED]:
