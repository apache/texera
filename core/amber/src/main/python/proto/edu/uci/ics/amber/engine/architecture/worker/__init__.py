...
class ControlReturnV2(betterproto.Message):
    control_exception: "ControlException" = betterproto.message_field(
        1, group="value")
    ...
    current_input_tuple_info: "CurrentInputTupleInfo" = betterproto.message_field(
        4, group="value")
    evaluated_value: "EvaluatedValue" = betterproto.message_field(
        5, group="value")
...
class UpdateInputLinkingV2(betterproto.Message):
    identifier: "__common__.ActorVirtualIdentity" = betterproto.message_field(
        1)
...
class AddPartitioningV2(betterproto.Message):
    ...
    partitioning: "_sendsemantics__.Partitioning" = betterproto.message_field(
        2)
...
class ControlCommandV2(betterproto.Message):
    start_worker: "StartWorkerV2" = betterproto.message_field(
        1, group="sealed_value")
    pause_worker: "PauseWorkerV2" = betterproto.message_field(
        2, group="sealed_value")
    resume_worker: "ResumeWorkerV2" = betterproto.message_field(
    ...
    python_print: "PythonPrintV2" = betterproto.message_field(
