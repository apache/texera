...
import edu.uci.ics.texera.web.resource.dashboard.workflow.{AccessLevel, WorkflowResource}
...
class ProjectResource {
  ...
  def listProjectWorkflows(
    ...
    WorkflowResource.fetchDashboardWorkflows(
      sessionUser.getUser.getUid,
      None, Some(pid)
    )
  }
  ...
  /**
    ...
    * @return
    */
  def toFileAccessLevel(userFileAccess: UserFileAccess): AccessLevel = {
