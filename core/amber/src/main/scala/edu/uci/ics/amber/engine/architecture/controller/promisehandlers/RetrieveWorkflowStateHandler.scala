...
import edu.uci.ics.amber.engine.architecture.rpc.controlcommands.{AsyncRPCContext, ChannelMarkerType, EmptyRequest, PropagateChannelMarkerRequest}
...
trait RetrieveWorkflowStateHandler {
  ...
  override def retrieveWorkflowState(request: EmptyRequest, ctx: AsyncRPCContext): Future[RetrieveWorkflowStateResponse] = {
