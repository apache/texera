package edu.uci.ics.texera.web.model.jooq;
...
public class RunCodeGen {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path jooqXmlPath = Utils.amberHomePath().resolve("..").resolve("conf").resolve("jooq-conf.xml");
        Configuration jooqConfig = GenerationTool.load(Files.newInputStream(jooqXmlPath));

        Path jdbcConfPath = Utils.amberHomePath().resolve("..").resolve("conf").resolve("jdbc.conf");
