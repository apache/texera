...
import edu.uci.ics.texera.workflow.operators.visualization.ScatterMatrixPlot.ScatterMatrixPlotOpDesc
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[ScatterMatrixPlotOpDesc], name = "ScatterMatrixPlot"),
