...
import edu.uci.ics.texera.web.model.jooq.generated.tables.records.UserActivityRecord;
...
public class UserActivity extends TableImpl<UserActivityRecord> {
    ...
    private static final long serialVersionUID = 1758075577;
    ...
    /**
     * The column <code>texera_db.user_activity.wid</code>.
     */
    public final TableField<UserActivityRecord, UInteger> WID = createField(DSL.name("wid"), org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");
