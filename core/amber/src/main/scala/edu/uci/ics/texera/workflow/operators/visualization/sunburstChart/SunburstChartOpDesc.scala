...
import edu.uci.ics.texera.workflow.operators.visualization.treemap.HierarchySection
...
class SunburstChartOpDesc extends VisualizationOperator with PythonOperatorDescriptor {
  ...
  @JsonPropertyDescription("the value associated to each sector")
  @AutofillAttributeName
  var value: String = ""

  @JsonProperty(required = true)
  @JsonSchemaTitle("Hierarchy Path")
  @JsonPropertyDescription("the hierarchy of sectors, from root to leaves")
  ...
  override def operatorInfo: OperatorInfo =
    OperatorInfo(
      "SunburstChart",
      "Visualize hierarchical data in a circular form",
