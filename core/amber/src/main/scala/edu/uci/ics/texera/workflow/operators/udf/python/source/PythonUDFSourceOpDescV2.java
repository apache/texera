...
public class PythonUDFSourceOpDescV2 extends SourceOperatorDescriptor {
    ...
    public PhysicalOp getPhysicalOp(long executionId, OperatorSchemaInfo operatorSchemaInfo) {
        ...
        if (workers > 1) {
            return PhysicalOp.sourcePhysicalOp(executionId, operatorIdentifier(), exec).withParallelizable(true).withOperatorSchemaInfo(operatorSchemaInfo)
                    .withIsOneToManyOp(true).withLocationPreference(Option.empty());
        } else {
            return PhysicalOp.sourcePhysicalOp(executionId, operatorIdentifier(), exec).withParallelizable(false).withOperatorSchemaInfo(operatorSchemaInfo).withIsOneToManyOp(true).withLocationPreference(Option.empty());
        }
