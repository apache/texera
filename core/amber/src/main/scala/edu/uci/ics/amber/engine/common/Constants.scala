...
object Constants {
  ...
  var storage: String = AmberUtils.amberConfig.getString("cache.storage")
  var mongodbUrl: String = AmberUtils.amberConfig.getString("cache.mongodb.url")
  var mongodbDatabaseName: String = AmberUtils.amberConfig.getString("cache.mongodb.database")
}
