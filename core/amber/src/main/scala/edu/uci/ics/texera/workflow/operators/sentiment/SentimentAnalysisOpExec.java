...
public class SentimentAnalysisOpExec extends MapOpExec {
    ...
    public SentimentAnalysisOpExec(SentimentAnalysisOpDesc opDesc, SchemaInfo schemaInfo) {
        this.opDesc = opDesc;
    ...
    public Tuple processTuple(Tuple t) {
        ...
        return Tuple.newBuilder(schemaInfo.outputSchema()).add(t).add(opDesc.resultAttribute, AttributeType.INTEGER, sentiment).build();
    }
