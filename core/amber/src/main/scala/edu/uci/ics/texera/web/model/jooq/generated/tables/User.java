...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = -1326947763;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USER_EMAIL, Indexes.USER_GOOGLE_ID, Indexes.USER_NAME, Indexes.USER_PRIMARY);
    }
    ...
    public List<UniqueKey<UserRecord>> getKeys() {
        return Arrays.<UniqueKey<UserRecord>>asList(Keys.KEY_USER_PRIMARY, Keys.KEY_USER_NAME, Keys.KEY_USER_EMAIL, Keys.KEY_USER_GOOGLE_ID);
    }
