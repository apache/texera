...
public class WorkflowRecord extends UpdatableRecordImpl<WorkflowRecord> implements Record6<String, UInteger, String, Timestamp, Timestamp, UInteger>, IWorkflow {

    private static final long serialVersionUID = -1770976171;
    ...
    @Override
    public Row6<String, UInteger, String, Timestamp, Timestamp, UInteger> valuesRow() {
    ...
    @Override
    public WorkflowRecord value6(UInteger value) {
        setOwnerUid(value);
        return this;
    }

    @Override
    public WorkflowRecord values(String value1, UInteger value2, String value3, Timestamp value4, Timestamp value5, UInteger value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowRecord(String name, UInteger wid, String content, Timestamp creationTime, Timestamp lastModifiedTime, UInteger ownerUid) {
        super(Workflow.WORKFLOW);
