...
public class WorkflowRecord extends UpdatableRecordImpl<WorkflowRecord> implements Record6<String, UInteger, String, Timestamp, Timestamp, Integer>, IWorkflow {

    private static final long serialVersionUID = 1999173244;
    ...
    @Override
    public Row6<String, UInteger, String, Timestamp, Timestamp, Integer> valuesRow() {
    ...
    @Override
    public WorkflowRecord value6(Integer value) {
        setVid(value);
        return this;
    }

    @Override
    public WorkflowRecord values(String value1, UInteger value2, String value3, Timestamp value4, Timestamp value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowRecord(String name, UInteger wid, String content, Timestamp creationTime, Timestamp lastModifiedTime, Integer vid) {
        super(Workflow.WORKFLOW);
