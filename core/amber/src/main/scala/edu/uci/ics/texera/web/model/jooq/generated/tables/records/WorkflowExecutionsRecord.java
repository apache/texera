...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record10<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, UInteger>, IWorkflowExecutions {

    private static final long serialVersionUID = 1157052464;
    ...
    @Override
    public Row10<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, UInteger> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord value10(UInteger value) {
        setUid(value);
        return this;
    }

    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, UInteger value3, Byte value4, String value5, Timestamp value6, Timestamp value7, Byte value8, String value9, UInteger value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger wid, UInteger vid, Byte status, String result, Timestamp startingTime, Timestamp completionTime, Byte bookmarked, String name, UInteger uid) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
