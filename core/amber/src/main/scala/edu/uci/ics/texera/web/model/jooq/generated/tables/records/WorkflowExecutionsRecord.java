...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record7<UInteger, UInteger, UInteger, Boolean, String, Timestamp, Timestamp>, IWorkflowExecutions {

    private static final long serialVersionUID = -919604106;
    ...
    @Override
    public Row7<UInteger, UInteger, UInteger, Boolean, String, Timestamp, Timestamp> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord value4(Boolean value) {
        setStatus(value);
        return this;
    }
    ...
    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, UInteger value3, Boolean value4, String value5, Timestamp value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger wid, UInteger vid, Boolean status, String result, Timestamp startingTime, Timestamp completionTime) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
