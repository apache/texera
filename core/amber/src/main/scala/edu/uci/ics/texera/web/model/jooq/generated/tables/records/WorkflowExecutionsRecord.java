...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record11<UInteger, UInteger, UInteger, Byte, String, LocalDateTime, LocalDateTime, Byte, String, String, String>, IWorkflowExecutions {
    ...
    @Override
    public Row11<UInteger, UInteger, UInteger, Byte, String, LocalDateTime, LocalDateTime, Byte, String, String, String> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, UInteger value3, Byte value4, String value5, LocalDateTime value6, LocalDateTime value7, Byte value8, String value9, String value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger vid, UInteger uid, Byte status, String result, LocalDateTime startingTime, LocalDateTime lastUpdateTime, Byte bookmarked, String name, String environmentVersion, String logLocation) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
