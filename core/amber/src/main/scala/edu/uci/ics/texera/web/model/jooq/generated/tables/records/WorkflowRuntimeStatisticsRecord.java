...
public class WorkflowRuntimeStatisticsRecord extends UpdatableRecordImpl<WorkflowRuntimeStatisticsRecord> implements Record11<UInteger, UInteger, String, Timestamp, UInteger, UInteger, Byte, UInteger, UInteger, UInteger, UInteger>, IWorkflowRuntimeStatistics {

    private static final long serialVersionUID = 489451290;
    ...
    @Override
    public Row11<UInteger, UInteger, String, Timestamp, UInteger, UInteger, Byte, UInteger, UInteger, UInteger, UInteger> valuesRow() {
    ...
    @Override
    public WorkflowRuntimeStatisticsRecord value8(UInteger value) {
        setDataProcessingTime(value);
        return this;
    }

    @Override
    public WorkflowRuntimeStatisticsRecord value9(UInteger value) {
        setControlProcessingTime(value);
        return this;
    }

    @Override
    public WorkflowRuntimeStatisticsRecord value10(UInteger value) {
        setIdleTime(value);
        return this;
    }
    ...
    @Override
    public WorkflowRuntimeStatisticsRecord values(UInteger value1, UInteger value2, String value3, Timestamp value4, UInteger value5, UInteger value6, Byte value7, UInteger value8, UInteger value9, UInteger value10, UInteger value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowRuntimeStatisticsRecord(UInteger workflowId, UInteger executionId, String operatorId, Timestamp time, UInteger inputTupleCnt, UInteger outputTupleCnt, Byte status, UInteger dataProcessingTime, UInteger controlProcessingTime, UInteger idleTime, UInteger numWorkers) {
        super(WorkflowRuntimeStatistics.WORKFLOW_RUNTIME_STATISTICS);
