...
public class WorkflowRuntimeStatisticsRecord extends UpdatableRecordImpl<WorkflowRuntimeStatisticsRecord> implements Record7<UInteger, UInteger, String, LocalDateTime, UInteger, UInteger, Byte>, IWorkflowRuntimeStatistics {
    ...
    @Override
    public Record4<UInteger, UInteger, String, LocalDateTime> key() {
    ...
    @Override
    public Row7<UInteger, UInteger, String, LocalDateTime, UInteger, UInteger, Byte> valuesRow() {
    ...
    @Override
    public WorkflowRuntimeStatisticsRecord value4(LocalDateTime value) {
        setTime(value);
        return this;
    }
    ...
    @Override
    public WorkflowRuntimeStatisticsRecord values(UInteger value1, UInteger value2, String value3, LocalDateTime value4, UInteger value5, UInteger value6, Byte value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowRuntimeStatisticsRecord(UInteger workflowId, UInteger executionId, String operatorId, LocalDateTime time, UInteger inputTupleCnt, UInteger outputTupleCnt, Byte status) {
        super(WorkflowRuntimeStatistics.WORKFLOW_RUNTIME_STATISTICS);
