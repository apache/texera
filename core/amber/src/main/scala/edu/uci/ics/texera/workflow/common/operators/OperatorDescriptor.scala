...
import edu.uci.ics.texera.workflow.operators.visualization.distributedBarChart.DistributedBarChartDesc
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[DistributedBarChartDesc], name = "DistributedBarchart"),
