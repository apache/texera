...
import edu.uci.ics.texera.workflow.operators.visualization.timeseries.TimeSeriesVisualizerOpDesc
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[TimeSeriesVisualizerOpDesc], name = "TimeSeriesVisualizer")
  )
)
