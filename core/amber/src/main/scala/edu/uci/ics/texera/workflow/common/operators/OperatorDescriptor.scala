...
import edu.uci.ics.texera.workflow.operators.visualization.treemap.TreeMapVisualizerOpDesc
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[TreeMapVisualizerOpDesc], name = "TreeMapVisualizer")
  )
)
