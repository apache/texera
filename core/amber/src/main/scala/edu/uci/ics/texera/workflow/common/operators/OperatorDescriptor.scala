...
import edu.uci.ics.texera.workflow.operators.visualization.aggregatedBarChart.AggregatedBarChartDesc
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[AggregatedBarChartDesc], name = "DistributedBarchart"),
