...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record5<String, UInteger, String, String, UserPermission>, IUser {

    private static final long serialVersionUID = -682263545;
    ...
    @Override
    public Row5<String, UInteger, String, String, UserPermission> valuesRow() {
    ...
    @Override
    public Field<UserPermission> field5() {
    ...
    @Override
    public UserPermission component5() {
    ...
    @Override
    public UserRecord value5(UserPermission value) {
        setPermission(value);
        return this;
    }

    @Override
    public UserRecord values(String value1, UInteger value2, String value3, String value4, UserPermission value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(String name, UInteger uid, String password, String googleId, UserPermission permission) {
        super(User.USER);
