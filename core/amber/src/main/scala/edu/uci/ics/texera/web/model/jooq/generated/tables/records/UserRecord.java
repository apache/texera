...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record5<String, UInteger, String, String, Integer>, IUser {

    private static final long serialVersionUID = -1172801497;
    ...
    @Override
    public Row5<String, UInteger, String, String, Integer> valuesRow() {
    ...
    @Override
    public UserRecord values(String value1, UInteger value2, String value3, String value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(String email, UInteger uid, String password, String googleId, Integer permission) {
        super(User.USER);
