...
public class Schema implements Serializable {
    ...
    public AmberTuple parse(String[] fieldStrings) throws ParseException {
        IField[] fields = new IField[attributes.size()];
        for (int i = 0; i< attributes.size(); ++i) {
            fields[i] = ParseUtils.getField(attributes.get(i).getType(), fieldStrings[i]);
        }
        return new AmberTuple(fields);
    }

    public Integer getIndex(String attributeName) {
	    	if (! containsAttribute(attributeName)) {
	    		throw new AmberException(attributeName + " is not contained in the schema");
	    	}
    ...
    public static void checkAttributeNotExists(Schema schema, String attributeName) {
        ...
        if (schema.containsAttribute(attributeName)) {
            throw new AmberException(ErrorMessages.DUPLICATE_ATTRIBUTE(
    ...
    public static void checkAttributeExists(Schema schema, String attributeName) {
        ...
        if (! schema.containsAttribute(attributeName)) {
            throw new AmberException(ErrorMessages.ATTRIBUTE_NOT_EXISTS(
                    schema, attributeName));
        }
    }
    ...
    public static class Builder {
         ...
         * @throws AmberException if the an attribute with the same name already exists
         */
        public Builder add(Attribute attribute) throws AmberException {
         ...
         * @throws AmberException if the an attribute with the same name already exists
         */
        public Builder add(String attributeName, AttributeType attributeType) throws AmberException {
            checkNotNull(attributeName);
         ...
         * @throws AmberException if the an attribute with the same name already exists
         */
        public Builder add(Iterable<Attribute> attributes) throws AmberException {
            checkNotNull(attributes);
         ...
         * @param attribute, the name of the attribute
         * @return this Builder object
         * @throws AmberException if an attribute does not exist
         */
        public Builder remove(String attribute) throws AmberException {
            checkNotNull(attribute);
         ...
         * @throws AmberException if an attribute does not exist
         */
        public Builder remove(Iterable<String> attributes) throws AmberException {
            checkNotNull(attributes);
            attributes.forEach(attr -> checkNotNull(attr));
         ...
         * @throws AmberException if an attribute does not exist
         */
        public Builder remove(String... attributes) throws AmberException {
            checkNotNull(attributes);
        ...
        public static Schema getSchemaWithID(Schema schema) {
            ...
            return new Builder().add(SchemaConstants._ID_ATTRIBUTE).add(schema).build();
        }
