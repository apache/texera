...
final case class Collect(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[Collect] {
    @transient
...
object Collect extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.testcommands.Collect] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TestcommandsProto.javaDescriptor.getMessageTypes().get(8)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TestcommandsProto.scalaDescriptor.messages(8)
