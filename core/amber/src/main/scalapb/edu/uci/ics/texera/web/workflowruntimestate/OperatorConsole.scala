...
final case class OperatorConsole(
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      evaluateExprResults.foreach { __item =>
        val __value = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole._typemapper_evaluateExprResults.toBase(__item)
        __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      }
      __size
    }
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      evaluateExprResults.foreach { __v =>
        val __m = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole._typemapper_evaluateExprResults.toBase(__v)
    ...
    def addEvaluateExprResults(__vs: (_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.EvaluatedValueList) *): OperatorConsole = addAllEvaluateExprResults(__vs)
    def addAllEvaluateExprResults(__vs: Iterable[(_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.EvaluatedValueList)]): OperatorConsole = copy(evaluateExprResults = evaluateExprResults ++ __vs)
    def withEvaluateExprResults(__v: _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.EvaluatedValueList]): OperatorConsole = copy(evaluateExprResults = __v)
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => consoleMessages
        case 2 => evaluateExprResults.iterator.map(edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole._typemapper_evaluateExprResults.toBase(_)).toSeq
      }
    }
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => _root_.scalapb.descriptors.PRepeated(evaluateExprResults.iterator.map(edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole._typemapper_evaluateExprResults.toBase(_).toPMessage).toVector)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToSingleLineUnicodeString(this)
    def companion: edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.type = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole
    // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.texera.web.OperatorConsole])
}

object OperatorConsole extends scalapb.GeneratedMessageCompanion[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole = {
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 18 =>
          __evaluateExprResults += edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole._typemapper_evaluateExprResults.toCustom(_root_.scalapb.LiteParser.readMessage[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry](_input__))
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole] = _root_.scalapb.descriptors.Reads{
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      ...
      case 2 => __out = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]](
      _root_.edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole(
  ...
  final case class EvaluateExprResultsEntry(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToSingleLineUnicodeString(this)
      def companion: edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry.type = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry
      // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.texera.web.OperatorConsole.EvaluateExprResultsEntry])
  }
  
  object EvaluateExprResultsEntry extends scalapb.GeneratedMessageCompanion[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __value = _root_.scala.Option(__value.fold(_root_.scalapb.LiteParser.readMessage[edu.uci.ics.texera.web.workflowruntimestate.EvaluatedValueList](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case tag => _input__.skipField(tag)
        }
      }
      edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry(
          key = __key,
          value = __value
      )
    }
    implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry(
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
      var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
      (__number: @_root_.scala.unchecked) match {
    ...
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
    lazy val defaultInstance = edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry(
      key = "",
      value = _root_.scala.None
    )
    implicit class EvaluateExprResultsEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry](_l) {
      def key: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.key)((c_, f_) => c_.copy(key = f_))
      def value: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.EvaluatedValueList] = field(_.getValue)((c_, f_) => c_.copy(value = _root_.scala.Option(f_)))
    ...
    @transient
    implicit val keyValueMapper: _root_.scalapb.TypeMapper[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry, (_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.EvaluatedValueList)] =
      _root_.scalapb.TypeMapper[edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry, (_root_.scala.Predef.String, edu.uci.ics.texera.web.workflowruntimestate.EvaluatedValueList)](__m => (__m.key, __m.getValue))(__p => edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry(__p._1, Some(__p._2)))
    def of(
      key: _root_.scala.Predef.String,
      value: _root_.scala.Option[edu.uci.ics.texera.web.workflowruntimestate.EvaluatedValueList]
    ): _root_.edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry = _root_.edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole.EvaluateExprResultsEntry(
      key,
      value
    )
    // @@protoc_insertion_point(GeneratedMessageCompanion[edu.uci.ics.texera.web.OperatorConsole.EvaluateExprResultsEntry])
  }
  
  implicit class OperatorConsoleLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole](_l) {
  ...
  ): _root_.edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole = _root_.edu.uci.ics.texera.web.workflowruntimestate.OperatorConsole(
    consoleMessages,
    evaluateExprResults
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[edu.uci.ics.texera.web.OperatorConsole])
}
