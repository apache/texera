...
final case class WorkerStatistics(
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => inputTupleCount.iterator.map(edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics._typemapper_inputTupleCount.toBase(_)).toSeq
        case 2 => outputTupleCount.iterator.map(edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics._typemapper_outputTupleCount.toBase(_)).toSeq
        case 3 => {
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.scalapb.descriptors.PRepeated(inputTupleCount.iterator.map(edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics._typemapper_inputTupleCount.toBase(_).toPMessage).toVector)
        case 2 => _root_.scalapb.descriptors.PRepeated(outputTupleCount.iterator.map(edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics._typemapper_outputTupleCount.toBase(_).toPMessage).toVector)
...
object WorkerStatistics extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics] {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics(
        inputTupleCount = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics.InputTupleCountEntry]]).getOrElse(_root_.scala.Seq.empty).iterator.map(edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics._typemapper_inputTupleCount.toCustom(_)).toMap,
        outputTupleCount = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.Seq[edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics.OutputTupleCountEntry]]).getOrElse(_root_.scala.Seq.empty).iterator.map(edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics._typemapper_outputTupleCount.toCustom(_)).toMap,
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics.InputTupleCountEntry
      case 2 => __out = edu.uci.ics.amber.engine.architecture.worker.statistics.WorkerStatistics.OutputTupleCountEntry
    }
    __out
  }
