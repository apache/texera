...
trait WorkerServiceFs2GrpcTrailers[F[_], A] {
  ...
  def prepareCheckpoint(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.FinalizeCheckpointRequest, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty, _root_.io.grpc.Metadata)]
  ...
  def updateExecutorCompleted(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.UpdateExecutorCompletedRequest, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty, _root_.io.grpc.Metadata)]
}
...
object WorkerServiceFs2GrpcTrailers extends _root_.fs2.grpc.GeneratedCompanion[WorkerServiceFs2GrpcTrailers] {
  ...
  def mkClient[F[_]: _root_.cats.effect.Async, A](dispatcher: _root_.cats.effect.std.Dispatcher[F], channel: _root_.io.grpc.Channel, mkMetadata: A => F[_root_.io.grpc.Metadata], clientOptions: _root_.fs2.grpc.client.ClientOptions): WorkerServiceFs2GrpcTrailers[F, A] = new WorkerServiceFs2GrpcTrailers[F, A] {
    ...
    def updateExecutorCompleted(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.UpdateExecutorCompletedRequest, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.workerservice.WorkerServiceGrpc.METHOD_UPDATE_EXECUTOR_COMPLETED, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
  }
  ...
  protected def serviceBinding[F[_]: _root_.cats.effect.Async, A](dispatcher: _root_.cats.effect.std.Dispatcher[F], serviceImpl: WorkerServiceFs2GrpcTrailers[F, A], mkCtx: _root_.io.grpc.Metadata => F[A], serverOptions: _root_.fs2.grpc.server.ServerOptions): _root_.io.grpc.ServerServiceDefinition = {
    _root_.io.grpc.ServerServiceDefinition
      ...
      .addMethod(edu.uci.ics.amber.engine.architecture.rpc.workerservice.WorkerServiceGrpc.METHOD_PREPARE_CHECKPOINT, _root_.fs2.grpc.server.Fs2ServerCallHandler[F](dispatcher, serverOptions).unaryToUnaryCallTrailers[edu.uci.ics.amber.engine.architecture.rpc.controlcommands.FinalizeCheckpointRequest, edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]((r, m) => mkCtx(m).flatMap(serviceImpl.prepareCheckpoint(r, _))))
      ...
      .addMethod(edu.uci.ics.amber.engine.architecture.rpc.workerservice.WorkerServiceGrpc.METHOD_UPDATE_EXECUTOR_COMPLETED, _root_.fs2.grpc.server.Fs2ServerCallHandler[F](dispatcher, serverOptions).unaryToUnaryCallTrailers[edu.uci.ics.amber.engine.architecture.rpc.controlcommands.UpdateExecutorCompletedRequest, edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]((r, m) => mkCtx(m).flatMap(serviceImpl.updateExecutorCompleted(r, _))))
      .build()
  }
