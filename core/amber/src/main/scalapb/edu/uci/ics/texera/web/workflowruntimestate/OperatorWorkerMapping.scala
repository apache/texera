...
final case class OperatorWorkerMapping(
    ...
    def companion: edu.uci.ics.texera.web.workflowruntimestate.OperatorWorkerMapping.type = edu.uci.ics.texera.web.workflowruntimestate.OperatorWorkerMapping
