...
final case class GenerateNumber(
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GenerateNumber] {
...
object GenerateNumber extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.testcommands.GenerateNumber] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TestcommandsProto.javaDescriptor.getMessageTypes().get(9)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TestcommandsProto.scalaDescriptor.messages(9)
