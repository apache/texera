...
trait WorkerServiceFs2Grpc[F[_], A] {
  def addInputChannel(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.AddInputChannelRequest, ctx: A): F[edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]
  def addPartitioning(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.AddPartitioningRequest, ctx: A): F[edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]
  def assignPort(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.AssignPortRequest, ctx: A): F[edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]
  ...
  def flushNetworkBuffer(request: edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty, ctx: A): F[edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]
...
object WorkerServiceFs2Grpc extends _root_.fs2.grpc.GeneratedCompanion[WorkerServiceFs2Grpc] {
  ...
  def mkClient[F[_]: _root_.cats.effect.Async, A](dispatcher: _root_.cats.effect.std.Dispatcher[F], channel: _root_.io.grpc.Channel, mkMetadata: A => F[_root_.io.grpc.Metadata], clientOptions: _root_.fs2.grpc.client.ClientOptions): WorkerServiceFs2Grpc[F, A] = new WorkerServiceFs2Grpc[F, A] {
    ...
    def updateExecutor(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.UpdateExecutorRequest, ctx: A): F[edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.workerservice.WorkerServiceGrpc.METHOD_UPDATE_EXECUTOR, dispatcher, clientOptions).flatMap(_.unaryToUnaryCall(request, m))
      }
    }
    def updateMultipleExecutors(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.UpdateMultipleExecutorsRequest, ctx: A): F[edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty] = {
      mkMetadata(ctx).flatMap { m =>
  ...
  protected def serviceBinding[F[_]: _root_.cats.effect.Async, A](dispatcher: _root_.cats.effect.std.Dispatcher[F], serviceImpl: WorkerServiceFs2Grpc[F, A], mkCtx: _root_.io.grpc.Metadata => F[A], serverOptions: _root_.fs2.grpc.server.ServerOptions): _root_.io.grpc.ServerServiceDefinition = {
    _root_.io.grpc.ServerServiceDefinition
      ...
      .addMethod(edu.uci.ics.amber.engine.architecture.rpc.workerservice.WorkerServiceGrpc.METHOD_ADD_INPUT_CHANNEL, _root_.fs2.grpc.server.Fs2ServerCallHandler[F](dispatcher, serverOptions).unaryToUnaryCall[edu.uci.ics.amber.engine.architecture.rpc.controlcommands.AddInputChannelRequest, edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]((r, m) => mkCtx(m).flatMap(serviceImpl.addInputChannel(r, _))))
      .addMethod(edu.uci.ics.amber.engine.architecture.rpc.workerservice.WorkerServiceGrpc.METHOD_ADD_PARTITIONING, _root_.fs2.grpc.server.Fs2ServerCallHandler[F](dispatcher, serverOptions).unaryToUnaryCall[edu.uci.ics.amber.engine.architecture.rpc.controlcommands.AddPartitioningRequest, edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]((r, m) => mkCtx(m).flatMap(serviceImpl.addPartitioning(r, _))))
      .addMethod(edu.uci.ics.amber.engine.architecture.rpc.workerservice.WorkerServiceGrpc.METHOD_ASSIGN_PORT, _root_.fs2.grpc.server.Fs2ServerCallHandler[F](dispatcher, serverOptions).unaryToUnaryCall[edu.uci.ics.amber.engine.architecture.rpc.controlcommands.AssignPortRequest, edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]((r, m) => mkCtx(m).flatMap(serviceImpl.assignPort(r, _))))
      ...
      .addMethod(edu.uci.ics.amber.engine.architecture.rpc.workerservice.WorkerServiceGrpc.METHOD_FLUSH_NETWORK_BUFFER, _root_.fs2.grpc.server.Fs2ServerCallHandler[F](dispatcher, serverOptions).unaryToUnaryCall[edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty, edu.uci.ics.amber.engine.architecture.rpc.controlreturns.Empty]((r, m) => mkCtx(m).flatMap(serviceImpl.flushNetworkBuffer(r, _))))
