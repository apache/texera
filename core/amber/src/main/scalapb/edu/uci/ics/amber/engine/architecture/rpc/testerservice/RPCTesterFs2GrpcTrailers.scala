...
trait RPCTesterFs2GrpcTrailers[F[_], A] {
  def sendPing(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Ping, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.IntResponse, _root_.io.grpc.Metadata)]
  def sendPong(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Pong, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.IntResponse, _root_.io.grpc.Metadata)]
  def sendNested(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Nested, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)]
  def sendPass(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Pass, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)]
  def sendErrorCommand(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.ErrorCommand, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)]
  def sendRecursion(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Recursion, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)]
...
object RPCTesterFs2GrpcTrailers extends _root_.fs2.grpc.GeneratedCompanion[RPCTesterFs2GrpcTrailers] {
  ...
  def mkClient[F[_]: _root_.cats.effect.Async, A](dispatcher: _root_.cats.effect.std.Dispatcher[F], channel: _root_.io.grpc.Channel, mkMetadata: A => F[_root_.io.grpc.Metadata], clientOptions: _root_.fs2.grpc.client.ClientOptions): RPCTesterFs2GrpcTrailers[F, A] = new RPCTesterFs2GrpcTrailers[F, A] {
    def sendPing(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Ping, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.IntResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_PING, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
    def sendPong(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Pong, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.IntResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_PONG, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
    def sendNested(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Nested, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_NESTED, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
    def sendPass(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Pass, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_PASS, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
    def sendErrorCommand(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.ErrorCommand, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_ERROR_COMMAND, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
    def sendRecursion(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Recursion, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_RECURSION, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
    def sendCollect(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Collect, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_COLLECT, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
    def sendGenerateNumber(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.GenerateNumber, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.IntResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
        _root_.fs2.grpc.client.Fs2ClientCall[F](channel, edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_GENERATE_NUMBER, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(request, m))
      }
    }
    def sendMultiCall(request: edu.uci.ics.amber.engine.architecture.rpc.controlcommands.MultiCall, ctx: A): F[(edu.uci.ics.amber.engine.architecture.rpc.controlreturns.StringResponse, _root_.io.grpc.Metadata)] = {
      mkMetadata(ctx).flatMap { m =>
  ...
  protected def serviceBinding[F[_]: _root_.cats.effect.Async, A](dispatcher: _root_.cats.effect.std.Dispatcher[F], serviceImpl: RPCTesterFs2GrpcTrailers[F, A], mkCtx: _root_.io.grpc.Metadata => F[A], serverOptions: _root_.fs2.grpc.server.ServerOptions): _root_.io.grpc.ServerServiceDefinition = {
    _root_.io.grpc.ServerServiceDefinition
      ...
      .addMethod(edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_PING, _root_.fs2.grpc.server.Fs2ServerCallHandler[F](dispatcher, serverOptions).unaryToUnaryCallTrailers[edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Ping, edu.uci.ics.amber.engine.architecture.rpc.controlreturns.IntResponse]((r, m) => mkCtx(m).flatMap(serviceImpl.sendPing(r, _))))
      .addMethod(edu.uci.ics.amber.engine.architecture.rpc.testerservice.RPCTesterGrpc.METHOD_SEND_PONG, _root_.fs2.grpc.server.Fs2ServerCallHandler[F](dispatcher, serverOptions).unaryToUnaryCallTrailers[edu.uci.ics.amber.engine.architecture.rpc.controlcommands.Pong, edu.uci.ics.amber.engine.architecture.rpc.controlreturns.IntResponse]((r, m) => mkCtx(m).flatMap(serviceImpl.sendPong(r, _))))
