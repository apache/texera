...
object EnvironmentalVariable {
  ...
  val ENV_OPERATOR_PARALLELISM_ALLOCATOR_TYPE = "OPERATOR_PARALLELISM_ALLOCATOR_TYPE"
  val ENV_OPERATOR_PARALLELISM_AVAILABLE_CORES = "OPERATOR_PARALLELISM_AVAILABLE_CORES"
  val ENV_OPERATOR_PARALLELISM_CORE_TO_WORKER_RATIO = "OPERATOR_PARALLELISM_CORE_TO_WORKER_RATIO"
