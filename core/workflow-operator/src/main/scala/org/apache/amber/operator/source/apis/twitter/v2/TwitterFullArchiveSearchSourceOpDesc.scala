...
import org.apache.amber.operator.source.apis.twitter.TwitterSourceOpDesc
  ...
  override def getPhysicalOp(
    ...
    PhysicalOp
      .sourcePhysicalOp(
        ...
        operatorIdentifier,
        OpExecWithClassName(
          "org.apache.amber.operator.source.apis.twitter.v2.TwitterFullArchiveSearchSourceOpExec",
