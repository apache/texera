          ...
          SchemaPropagationFunc(inputSchemas =>
            Map(
              PortIdentity(internal = true) -> Schema(
                List(new Attribute(HASH_JOIN_INTERNAL_KEY_NAME, AttributeType.ANY))).add(inputSchemas(
      ...
      PhysicalOp
        ...
        .withPropagateSchema(
          SchemaPropagationFunc(inputSchemas => {
            ...
            val leftAttributes = buildSchema.getAttributes.filterNot(_.getName == HASH_JOIN_INTERNAL_KEY_NAME)
