...
import { NavigationComponent } from "./workspace/component/menu/navigation.component";
...
import { CoeditorUserIconComponent } from "./workspace/component/menu/coeditor-user-icon/coeditor-user-icon/coeditor-user-icon.component";
