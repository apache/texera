...
export class GmailComponent implements OnInit {
  ...
  getEmail() {
    this.gmailAuthService.getEmail()
  ...
  public auth() {
    ...
    this.gmailAuthService.googleCredentialResponse
      .pipe(untilDestroyed(this))
      .subscribe(() => this.getEmail());
  }

  public revoke() {
    this.gmailAuthService.deleteEmail().pipe(untilDestroyed(this)).subscribe(() => this.getEmail());
  }
}
