...
export class StubAdminUserService implements PublicInterfaceOf<UserService> {
  public testUFAs: AccessEntry[] = [];
  private userFiles: DashboardUserFileEntry[] = [];
  private userFilesChanged = new Subject<null>();

  constructor(private http: HttpClient, private userService: StubAdminUserService) {
    StubAdminUserService.detectUserChanges();
  }
