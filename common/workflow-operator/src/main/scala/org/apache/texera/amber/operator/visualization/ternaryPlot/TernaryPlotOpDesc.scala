...
class TernaryPlotOpDesc extends PythonOperatorDescriptor with StandaloneCodeGenerator {
  ...
  @AutofillAttributeName @SampleColumn("comp_a") var firstVariable: EncodableString = ""
  ...
  @AutofillAttributeName @SampleColumn("comp_b") var secondVariable: EncodableString = ""
  ...
  @AutofillAttributeName @SampleColumn("comp_c") var thirdVariable: EncodableString = ""
