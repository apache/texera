...
# Frontend npm license manifest: auto-generated by Angular CLI's
# extractLicenses: true (see frontend/angular.json production config).
# Authoritative list of every bundled npm package and its license.
COPY --from=build-frontend /frontend/dist/3rdpartylicenses.txt /texera/licenses/frontend-npm-3rdparty.txt
