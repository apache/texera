...
class TestLargeBinaryOutputStream:
    ...
    def test_write_data(self, big_object):
    ...
    def test_write_multiple_chunks(self, big_object):
    ...
    def test_close_completes_upload(self, big_object):
    ...
    def test_context_manager(self, big_object):
    ...
    def test_close_handles_upload_error(self, big_object):
    ...
    def test_write_after_upload_error_raises_error(self, big_object):
    ...
    def test_multiple_close_calls(self, big_object):
